...
# Read in data
album_rate <- read_csv("./data/album_rate.csv")
album_rev <- read_csv("./data/album_rev.csv")

# Plot 1
rate_barplot <- ggplot(album_rate, aes(x=`Release Year`)) +
  geom_bar()

ggsave("./figures/rate_barplot.png",plot =rate_barplot)
...
ggsave("./figures/rev_barplot.png",plot =rev_barplot)