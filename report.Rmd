...
![](./figures/popyear.png){width=50%}

![](./figures/rockyear.png){width=50%}
...
I am also interested to find out if there is a pattern in the time of release for albums. So, I made heatmaps based on the number of album releases on each day of a calendar year. 
